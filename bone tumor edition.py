...
main.mainloop()
def medicineFunction():
    # You can add the functionality for the Medicine button here
    text.insert(END, "Medicine button clicked\n")
...
medicineButton = Button(main, text="Medicine", command=medicineFunction)
medicineButton.place(x=430, y=650)
medicineButton.config(font=font1)
